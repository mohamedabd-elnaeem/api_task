...
public class ProAvailabilityService {
    ...
    public ProAvailabilityService(AppointmentRepository appointmentRepository, AvailabilityRepository availabilityRepository, TimeSlotRepository timeSlotRepository) {
